(function () {
  ...
  Include = {
    ...
    cornerParity: function () {
      ...
      s = 0;
      for (
        i = m = ref = DRB, ref1 = URF + 1;
        ref <= ref1 ? m <= ref1 : m >= ref1;
        i = ref <= ref1 ? ++m : --m
      ) {
        for (
          j = o = ref2 = i - 1, ref3 = URF;
          ref2 <= ref3 ? o <= ref3 : o >= ref3;
          j = ref2 <= ref3 ? ++o : --o
        ) {
    ...
    edgeParity: function () {
      ...
      s = 0;
      for (
        i = m = ref = BR, ref1 = UR + 1;
        ref <= ref1 ? m <= ref1 : m >= ref1;
        i = ref <= ref1 ? ++m : --m
      ) {
        for (
          j = o = ref2 = i - 1, ref3 = UR;
          ref2 <= ref3 ? o <= ref3 : o >= ref3;
          j = ref2 <= ref3 ? ++o : --o
        ) {
  ...
  Cube.prototype.solveUpright = function (maxDepth = 22) {
    ...
    phase1 = function (state, depth) {
      ...
      if (depth === 0) {
        if (state.minDist1() === 0) {
          ...
          if (
            state.lastMove === null ||
            ((ref = state.lastMove), indexOf.call(allMoves2, ref) < 0)
          ) {
    ...
    phase2search = function (state) {
      ...
      results = [];
      for (
        depth = m = 1, ref = maxDepth - state.depth;
        1 <= ref ? m <= ref : m >= ref;
        depth = 1 <= ref ? ++m : --m
      ) {
        phase2(state, depth);
